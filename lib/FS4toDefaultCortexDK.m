function FS4toDefaultCortexDK
	...
	if useMNEdec
		...
		V1R = freesurfer_read_surf(fullfile(FSdir,'surf','rh.white'));
		V1R = [ -V1R(src(2).vertno,2:3), V1R(src(2).vertno,1) ] + 128;
		V2R = freesurfer_read_surf(fullfile(FSdir,'surf','rh.pial'));
